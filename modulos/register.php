...
if (isset($_POST['enviar'])) {
    ...
    $result = $user->registrar_usuario($username , $password, $cpassword,  $nombre, $apellido, $celular);
            ...
            <form class="Register-form" action="" method="POST">
              ...
              <div class="form-group">
               ...
               <button type="submit" class="registrarse-button" name="enviar">Registrarse</button>
                ...
                <p class="register_label">No tienes una cue? <a href="?p=register">Regístrate</a></p> 
            </form>
